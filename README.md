...
`dotnet new console -o project-name` | The cleanest way to creat a project  | dotnet new console –o | https://github.com/forsbergsskola-se/gp21-21-0927-csharp-basics-nim-Sami-Olsson/blob/main/slides/003.1-hello-world.md#1-create-a-project
